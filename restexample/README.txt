...
a persistence unit "restexamplePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "restexample/pom.xml":
...
artifact ("restexample.war") is already built. You can build
