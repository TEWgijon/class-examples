...
a persistence unit "ajaxPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ajax/pom.xml":
...
artifact ("ajax.war") is already built. You can build
